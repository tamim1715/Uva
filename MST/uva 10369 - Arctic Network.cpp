...
int main()
{
    ...
    int tst,n,m,n1,n2,x,y,num1,num2;
    double sum=0.00, a,b,x1,x2,y1,y2,d,difx,dify;
    cin>>tst;
    //cout<<"tamim"<<endl;
    bool flag=false;
    while(tst--)
    {
        ...
        {
            cout<<v1[i].second.first<<" "<<v1[i].second.second<<" "<<v1[i].first<<endl;
        }*/
